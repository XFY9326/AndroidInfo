...
SOURCE_CODE_QUERY_EXCLUDE_PATH: str = "-path:sample/ -path:samples/ -path:test/ -path:tests/ -path:androidTest/ -path:example/ -path:demos/ " + \
                                      "-path:cts/apps/ -path:cts/common/ -path:prebuilts/ -path:tools/ -path:demoProjects/ "

JVM_CONSTRUCTOR_NAME = "<init>"
JVM_CONSTRUCTOR_RETURN = "void"
